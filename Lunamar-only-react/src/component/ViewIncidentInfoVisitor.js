...
class ViewIncidentInfoVisitor extends Component {
  ...
  async componentDidMount() {
    ...
    if(role === "Admin" || role === "Manager"){
      data.append("reportedFor", "Visitor");
    ...
    return (
      <>
        ...
        <div className="welcome-text" style={{ height: "110%" }}>
          <h1>
            <span>Edit Incident / Reques Information</span>
          </h1>
...
export default ViewIncidentInfoVisitor;
