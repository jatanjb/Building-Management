...
class AddVisitorGarden extends Component{
...
formData.append("garden_name",this.state.garden_name);
...
render(){
  //  const history = useHistory();
    return (
    <main>
    <div className="welcome-text" style={{height: "160%"}}>
        ...
        <form className="loginbox" autocomplete="off" onSubmit={this.handleSubmit}>
            ...
            <br></br>
            <input onChange={this.handleAdd} name="garden_name" placeholder="Garden Name" type="text" id="garden_name" required></input>
            <br></br>
...
export default AddVisitorGarden;
